...
![AFNetworking 架构图](/images/AF_Archi.png)
...
上面的代码展示了 AFNetworking 如何处理网络请求的整个流程。对于一个完整的 POST 请求流程，可以用下图总结：

![POST 请求流程图](/images/POST_Flow.png)
